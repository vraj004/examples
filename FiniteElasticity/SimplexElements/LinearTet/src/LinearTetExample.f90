...
!> \example FiniteElasticity/SimplexElements/LinearTet/src/LinearTetExample.f90
!! Example program to solve a finite elasticity equation using OpenCMISS calls.
!! \par Latest Builds:
!! \li <a href='http://autotest.bioeng.auckland.ac.nz/opencmiss-build/logs_x86_64-linux/FiniteElasticity/SimplexElements/LinearTet/build-intel'>Linux Intel Build</a>
!! \li <a href='http://autotest.bioeng.auckland.ac.nz/opencmiss-build/logs_x86_64-linux/FiniteElasticity/SimplexElements/LinearTet/build-gnu'>Linux GNU Build</a>
!<

!> Main program
PROGRAM LINEARTETEXAMPLE
...
>>>>>>> upstream/master
  ...
  CALL cmfe_Fields_NodesExport(Fields,"LinearTet","FORTRAN",Err)
  CALL cmfe_Fields_ElementsExport(Fields,"LinearTet","FORTRAN",Err)
