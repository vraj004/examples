...
!> \example ClassicalField/ReactionDiffusion/CellMLSplitReactionDiffusion3D/src/CellMLSplitReactionDiffusion3DExample.f90
!! Example program to solve a diffusion equation using openCMISS calls.
!! \htmlinclude ClassicalField/ReactionDiffusion/CellMLSplitReactionDiffusion3D/history.html
!<

!> Main program
PROGRAM CELLMLSPLITREACTIONDIFFUSION3DEXAMPLE
  ...
  IF(EXPORT_FIELD) THEN
    ...
    CALL CMISSFields_NodesExport(Fields,"CellMLSplitReactionDiffusion3D","FORTRAN",Err)
    CALL CMISSFields_ElementsExport(Fields,"CellMLSplitReactionDiffusion3D","FORTRAN",Err)
...
END PROGRAM CELLMLSPLITREACTIONDIFFUSION3DEXAMPLE
