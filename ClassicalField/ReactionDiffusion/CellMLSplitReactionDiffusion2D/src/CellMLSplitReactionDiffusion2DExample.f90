...
!> \example ClassicalField/ReactionDiffusion/CellMLSplitReactionDiffusion1D/src/CellMLSplitReactionDiffusion2DExample.f90
!! Example program to solve a diffusion equation using openCMISS calls.
!! \htmlinclude ClassicalField/ReactionDiffusion/CellMLSplitReactionDiffusion2D/history.html
!<

!> Main program
PROGRAM CELLMLSPLITREACTIONDIFFUSION2DEXAMPLE
  ...
  REAL(CMISSDP), PARAMETER :: LENGTH=100.0_CMISSDP,WIDTH=100.0_CMISSDP
  ...
  INTEGER(CMISSIntg),DIMENSION(21) :: BCNODES
  ...
  NUMBER_GLOBAL_ELEMENTS = NUMBER_GLOBAL_X_ELEMENTS*NUMBER_GLOBAL_Y_ELEMENTS
  ...
  !Start the creation of a basis (default is bilinear lagrange)
  ...
  CALL CMISSField_ComponentValuesInitialise(MaterialsField,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE, &
   & 1,10.5_CMISSDP,Err) !diff coeff in x
  CALL CMISSField_ComponentValuesInitialise(MaterialsField,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE, &
   & 2,10.5_CMISSDP,Err) !diff coeff in x
  CALL CMISSField_ComponentValuesInitialise(MaterialsField,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE, &
  ...
  CALL CMISSField_ParameterSetUpdateNode(CellMLModelsField,CMISS_FIELD_U_VARIABLE_TYPE, &
    & CMISS_FIELD_VALUES_SET_TYPE,1,1,8,1,1_CMISSIntg,Err)
  CALL CMISSField_ParameterSetUpdateNode(CellMLModelsField,CMISS_FIELD_U_VARIABLE_TYPE, &
    & CMISS_FIELD_VALUES_SET_TYPE,1,1,29,1,1_CMISSIntg,Err)
  CALL CMISSField_ParameterSetUpdateNode(CellMLModelsField,CMISS_FIELD_U_VARIABLE_TYPE, &
    & CMISS_FIELD_VALUES_SET_TYPE,1,1,22,1,1_CMISSIntg,Err)
  CALL CMISSField_ParameterSetUpdateNode(CellMLModelsField,CMISS_FIELD_U_VARIABLE_TYPE, &
    & CMISS_FIELD_VALUES_SET_TYPE,1,1,15,1,1_CMISSIntg,Err)
  ...
  BCNODES = (/1,2,3,4,5,6,31,32,33,34,35,36,7,13,19,25,6,12,18,24,30/)
  ...
  IF(EXPORT_FIELD) THEN
    ...
    CALL CMISSFields_NodesExport(Fields,"CellMLSplitReactionDiffusion2D","FORTRAN",Err)
    CALL CMISSFields_ElementsExport(Fields,"CellMLSplitReactionDiffusion2D","FORTRAN",Err)
...
END PROGRAM CELLMLSPLITREACTIONDIFFUSION2DEXAMPLE
