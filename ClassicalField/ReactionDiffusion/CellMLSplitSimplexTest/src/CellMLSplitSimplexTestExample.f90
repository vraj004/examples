...
!> Main program
PROGRAM CELLMLSPLITSIMPLEXTESTEXAMPLE
  ...
  IF(EXPORT_FIELD) THEN
    ...
    CALL CMISSFields_NodesExport(Fields,"Simplex_3Dmesh","FORTRAN",Err)
    CALL CMISSFields_ElementsExport(Fields,"Simplex_3Dmesh","FORTRAN",Err)
  ...
  IF(EXPORT_FIELD) THEN
    CALL CMISSFields_Initialise(Fields,Err)
    CALL CMISSFields_Create(Region,Fields,Err)
    CALL CMISSFields_NodesExport(Fields,"CellMLSplitReacDiffSimplexTest","FORTRAN",Err)
    CALL CMISSFields_ElementsExport(Fields,"CellMLSplitReacDiffSimplexTest","FORTRAN",Err)
    CALL CMISSFields_Finalise(Fields,Err)
...
END PROGRAM CELLMLSPLITSIMPLEXTESTEXAMPLE
