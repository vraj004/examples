...
!> \example ClassicalField/ReactionDiffusion/CellMLSplitSimplexParallel/src/CellMLSplitReacDiffSimplexParallelExample.f90
!! Example program to solve a diffusion equation using openCMISS calls.
!! \htmlinclude ClassicalField/ReactionDiffusion/CellMLSplitSimplexParallel/history.html
!<

!> Main program
PROGRAM CELLMLSPLITREACDIFFSIMPLEXPARALLELEXAMPLE
  ...
  IF(EXPORT_FIELD) THEN
    ...
    CALL CMISSFields_NodesExport(Fields,"CellMLSplitReacDiffSimplexParallel","FORTRAN",Err)
    CALL CMISSFields_ElementsExport(Fields,"CellMLSplitReacDiffSimplexParallel","FORTRAN",Err)
...
END PROGRAM CELLMLSPLITREACDIFFSIMPLEXPARALLELEXAMPLE
